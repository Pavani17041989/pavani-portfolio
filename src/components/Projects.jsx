    ...
    <div>
      ...
      <div className="project-container">
        <div className="project-card">
          <img
            src="./src/assets/images/upload/v1709376742/Netflix__Here_s_the_list_of_top_20_trending_movies_series_in_December_dzjeyo.jpg"
            alt="project1"
        ...
        <div className="project-card">
          <img
            src="./src/assets/images/upload/v1709380062/Free_Vector___E-commerce_round_composition_iyyl6b.jpg"
            alt="project2"
            className="project-image"
          />
          <div className="project-content">
        ...
        <div className="project-card">
          <img
            src="./src/assets/images/upload/v1709380058/Download_Rock_Paper_Scissors_Neon_Icons_for_free_vngpjq.jpg"
            alt="project3"
            className="project-image"
          />
          <div className="project-content">
        ...
        <div className="project-card">
          <img
            src="./src/assets/images/upload/v1710001008/Premium_Vector___Jobs_search_recruitment_hiring_employment_find_job_openings_opportunities_for_career_growth_young_unemployed_man_uses_a_mag.jpg"
            alt="project6"
            className="project-image"
          />
          <div className="project-content">
        ...
        <div className="project-card">
          <img
            src="./src/assets/images/upload/v1709380071/38833_1_apfnyy.jpg"
            alt="project7"
            className="project-image"
          />
          <div className="project-content">
